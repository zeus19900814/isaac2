...
NEIGHBORS_1or2_FILES:=$(foreach s,$(SEED_LENGTHS), $(TEMP_DIR)/neighbors-1or2-$(s)$(NEIGHBORS_FILE_SUFFIX))
.SECONDEXPANSION:
$(NEIGHBORS_1or2_FILES): $(TEMP_DIR)/neighbors-1-$$(target_seed_length)$(NEIGHBORS_FILE_SUFFIX) $(TEMP_DIR)/neighbors-2-$$(target_seed_length)$(NEIGHBORS_FILE_SUFFIX)
...
.SECONDEXPANSION:
$(ALL_GENOME_NEIGHBORS_DAT): $(TEMP_DIR)/neighbors-1or2-$$(target_seed_length)$(NEIGHBORS_FILE_SUFFIX) $(CONTIGS_XML)
